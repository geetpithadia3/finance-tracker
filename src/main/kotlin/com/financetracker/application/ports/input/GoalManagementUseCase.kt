...
interface GoalManagementUseCase {
  fun createGoal(request: CreateGoalRequest, user: User): GoalResponse

  fun updateGoalProgress(request: UpdateGoalProgressRequest, user: User): GoalResponse

  fun listGoals(user: User): List<GoalResponse>
}

...
//            logger.info("Goal created successfully for user: ${user.username}, goalId:
// ${response.id}")
...
//        val user = getCurrentUser()
//        logger.info("Received update goal progress request for user: ${user.username}, goalId:
// ${request.goalId}")
//        return try {
//            val response = goalManagementUseCase.updateGoalProgress(request, user)
//            logger.info("Goal progress updated successfully for user: ${user.username}, goalId:
// ${response.id}")
//            ResponseEntity.ok(response)
//        } catch (e: Exception) {
//            logger.error("Error updating goal progress for user: ${user.username}, goalId:
// ${request.goalId}", e)
//            throw e
//        }
//    }
